...
// Plasmic Project: krZBQW5BJ8nScYQioLBGie
// Component: mjqWzV2gTia-
...
import projectcss from "./plasmic.module.css"; // plasmic-import: krZBQW5BJ8nScYQioLBGie/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: mjqWzV2gTia-/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: rkcM7ToaLdOv/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 87a28e8ooFzi/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__e8SHs)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__piB9I)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__hj8YI)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__bqQs6)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__cu0P7)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
